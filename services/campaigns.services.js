        ...
        try {
            ...
            const volunteer = await User.findById(userId)
                .populate({
                    ...
                    select: 'name description startDate endDate status location address image gallery',
                    populate: {
                        path: 'phases',
            ...
            const error = new Error(`Failed to get volunteer campaign list: ${err.message}`);
