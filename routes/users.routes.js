...
usersRoutes.post(
  ...
  registerValidator,
  wrapRequestHandler(registerOrganizationController)
);

usersRoutes.put(
  "/approved-organization/:userId",
  wrapRequestHandler(approvedOrganization)
);
...
usersRoutes.post("/forgot-password", wrapRequestHandler(resetPassword));
